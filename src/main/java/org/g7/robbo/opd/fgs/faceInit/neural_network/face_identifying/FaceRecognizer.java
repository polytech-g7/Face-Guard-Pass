...
import org.g7.robbo.opd.fgs.faceInit.neural_network.face_detection.BufferedFace;
...
import org.g7.robbo.opd.fgs.faceInit.neural_network.utils.FileUtils;
...
public class FaceRecognizer {
    ...
    private Prediction predictBestMatchFromPool(FaceFeatures userToFind, FullFaceFeatures[] collectedFeatures) {
        ...
        System.out.println("my user = " + userToFind.getFaceType());
        final int inputFaceType = userToFind.getFaceType();
        for (int i = 0; i < collectedFeatures.length; i++) {
            System.out.println("1!" + collectedFeatures[0]);
